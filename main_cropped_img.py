...
# Define INR Model
class INR(nn.Module):
    def __init__(self, input_dim=2, hidden_dim=256, output_dim=3,positional_encoding=None):
        super(INR, self).__init__()
        self.positional_encoding = positional_encoding
        if positional_encoding:
            input_dim = input_dim + positional_encoding.num_encoding_functions * 2 * (1 + positional_encoding.include_input) 
            #print(input_dim)
        ...
        self.net = nn.Sequential(
            ...
            SineLayer(hidden_dim, hidden_dim*2),
